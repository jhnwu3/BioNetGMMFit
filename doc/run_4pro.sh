...
./BNGMM -m example/4_prot_CD3_CD8_CD28/4proV2.bngl -c example/4_prot_CD3_CD8_CD28/Config4pro.csv -x example/4_prot_CD3_CD8_CD28/1min_2min/X/ -y example/4_prot_CD3_CD8_CD28/1min_2min/Y/ -t example/4_prot_CD3_CD8_CD28/time_steps.csv -o test/
