...
MatrixXd linearModel(int nParts, int nSteps, int nParticles2, int nSteps2, MatrixXd& X_0, int nRates, int nMoments, const VectorXd &times, int simulateYt, int useInverse, int argc, char** argv);
